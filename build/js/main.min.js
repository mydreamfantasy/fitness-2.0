...
exports.getSwiperSecond = exports.getSwiper = void 0;
var getSwiper = function getSwiper() {
  var swiperFirst = new Swiper('.trainers__swiper', {
    allowTouchMove: true,
    loop: true,
    navigation: {
...
var getSwiperSecond = function getSwiperSecond() {
  var swiperSecond = new Swiper('.review-swiper', {
    slidesPerView: 1,
    // centeredSlides: true,
    spaceBetween: 30,
    navigation: {
...
exports.getSwiperSecond = getSwiperSecond;
...
},{"../../media/video":21}],17:[function(require,module,exports){
"use strict";
