...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _video.initVideo)();
  (0, _swiper.getSwiper)();
  (0, _swiper.getSwiperReview)();
  (0, _swiper.removeNotJs)();
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/swiper":13,"./modules/tabs/init-tabs":14,"./modules/video":16,"./utils/ios-vh-fix":19}],2:[function(require,module,exports){
"use strict";
...
exports.removeNotJs = exports.getSwiperReview = exports.getSwiper = void 0;
...
var getSwiperReview = function getSwiperReview() {
  if (!swiperContainer) {
    return;
  } else {
    var swiper = new _swiper.default('[data-swiper="reviews"]', {
      direction: 'horizontal',
      slidesPerView: 1,
      watchOverflow: true,
      loop: false,
...
exports.getSwiperReview = getSwiperReview;
...
exports.removeNotJs = removeNotJs;
...
var Tabs = /*#__PURE__*/function () {
  ...
  _createClass(Tabs, [{
    ...
    value: function openTab(control) {
      ...
      var newHeight = tabElements[currentIndex] && tabElements[currentIndex].offsetHeight;
...
var _video = require("../../media/video");
...
},{"../../media/video":22}],17:[function(require,module,exports){
"use strict";
