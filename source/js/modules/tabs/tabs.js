export class Tabs {
  ...
  openTab(control) {
    ...
    const newHeight = tabElements[currentIndex] && tabElements[currentIndex].offsetHeight
    ...
    if (tabElements[currentIndex]) {
      if (currentHeight > newHeight) {
        ...
        setTimeout(() => {
          control.classList.add("is-active")
          tabElements[currentIndex] && tabElements[currentIndex].classList.add("is-active")
          parentElement.classList.remove("no-action")
        }, dataDelay)
      }
    }
